 ...
 */
final class Version20200402074845 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE products ADD created_at DATETIME NOT NULL, ADD updated_at DATETIME NOT NULL');
    }
